...
public function __construct(array $configuration, $plugin_id, $plugin_definition, AccountInterface $account,FormBuilderInterface $form_builder) {
  ...
  public function build(){
     ...
     $form  = $this->formBuilder->getForm('\Drupal\custom_user\Form\CustomUserDetails');
